...
import type { SalePayload, Sale, SaleItem } from '../types'
  ...
  return (
    <div className="min-h-screen bg-sheen-cream">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <PosMenuPicker source={effectiveSource} resetSignal={resetSignal} onChange={setOrderLines} />

        {/* ── Order source + Subtotal + Record button ── */}
        <div className="bg-sheen-white rounded-xl shadow-sm p-6 mb-8 space-y-3">
            {/* Order Source */}
            <div>
