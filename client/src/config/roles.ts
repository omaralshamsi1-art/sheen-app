...
export const navItems: NavItem[] = [
  ...
  { to: '/offers-admin', labelKey: 'tabOffers' as TranslationKey, icon: '', roles: ['admin'] },
  { to: '/order',      labelKey: 'orderNow' as TranslationKey, icon: '', roles: ['customer'] },
  { to: '/my-orders',  labelKey: 'myOrders' as TranslationKey, icon: '', roles: ['customer'] },
  { to: '/my-profile', labelKey: 'myProfile' as TranslationKey, icon: '', roles: ['customer'] },
  ...
  { to: '/attendance',         labelKey: 'attendance' as TranslationKey, icon: '', roles: ['admin', 'staff'] },
  { to: '/attendance/admin',   labelKey: 'attendanceAdmin' as TranslationKey, icon: '', roles: ['admin'] },
